            ...
            <div class="event-list upcoming-list">
                <c:forEach var="event" items="${events}" varStatus="loop">
                    <c:if test="${loop.index lt 3}">
                        ...
                        <a class="upcoming-event-card event-visual-${event.catId}" href="${ctx}/app/events">
                            <span class="event-poster-shade"></span>
                            <span class="upcoming-card-content">
                                <span class="event-meta">
                                    <span class="pill poster-pill"><c:out value="${event.categoryName}"/></span>
                                    <span class="pill poster-pill amber">${event.hours} hours</span>
                                </span>
